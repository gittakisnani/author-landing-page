...
const ManSection = () => {
  return (
    <section id='author' className='flex items-center'>
        ...
        <div className='p-8 py-12 bg-gray-200/70 self-stretch md:basis-1/2'>
            ...
            <div className='flex gap-10 my-4 p-1 text-lg'>
                ...
                <div className='flex flex-col gap-2 text-slate-700/40'>
                    <p className='text-black'>Franklin Henderson</p>
                    <p className='text-black'>November 28, 1980</p>
                    <p className='text-black'>San Francisco CA 97987 USA</p>
                    <p className='text-black'>1000</p>
                    <p className='text-black'>takisnbusiness@gmail.com</p>
                    <p className='text-black'>+1-2234-5678-9-0</p>
                </div>
            </div>
